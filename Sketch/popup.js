...
let slider1,
  ...
  function mouseClicked() {
    ...
    if (
      ...
      messageBackground({"timerLength": studyTime, "breakLength": breakTime, "reset":true,"timerOn": true })
    }
    //Click exit button
    else if (
      mouseX > 200 &&
      ...
      messageBackground({"timerLength": studyTime, "breakLength": breakTime, "reset":false,"timerOn":false})
    }
  };
